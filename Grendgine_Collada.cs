...
namespace rMap.Asset.FileTypes.Collada
{
	...
	public partial class Grendgine_Collada
	{
        ...
        public static Grendgine_Collada Grendgine_Load_File(byte[] file)
        {
        ...
        public static void Grendgine_Save_File(string file_name, Grendgine_Collada collada)
        {
            XmlSerializer sr = new XmlSerializer(typeof(Grendgine_Collada));
            TextWriter tr = new StreamWriter(file_name, false);
            sr.Serialize(tr, collada);
